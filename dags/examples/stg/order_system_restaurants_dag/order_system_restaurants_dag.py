...
from examples.stg.order_system_restaurants_dag.pg_saver1 import PgSaver1
from examples.stg.order_system_restaurants_dag.pg_saver2 import PgSaver2
...
def sprint5_example_stg_order_system_restaurants():
    ...
    def load_users():
        ...
        # Инициализируем класс, в котором реализована бизнес-логика загрузки данных.
        loader = UserLoader(collection_reader, dwh_pg_connect, pg_saver1, log)
    ...
    def load_orders():
        ...
        # Инициализируем класс, в котором реализована бизнес-логика загрузки данных.
        loader = OrderLoader(collection_reader, dwh_pg_connect, pg_saver2, log)
