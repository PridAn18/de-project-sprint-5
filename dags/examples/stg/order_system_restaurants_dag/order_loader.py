...
class OrderLoader:
    ...
    def __init__(self, collection_loader: OrderReader, pg_dest: PgConnect, pg_saver2: PgSaver2, logger: Logger) -> None:
        self.collection_loader = collection_loader
        self.pg_saver2 = pg_saver2
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.pg_saver2.save_object(conn, str(d["_id"]), d["update_ts"], d)
