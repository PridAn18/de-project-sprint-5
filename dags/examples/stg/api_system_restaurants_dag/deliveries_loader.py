...
class DeliveriesLoader:
    ...
    WF_KEY = "example_apisystem_deliveries_origin_to_stg_workflow"
    LAST_LOADED_TS_KEY = "last_loaded_ts"

    def __init__(self, collection_loader: DeliveriesReader, pg_dest: PgConnect, pg_saver: PgSaverDeliveries, logger: Logger) -> None:
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_deliveries(last_loaded_ts, self._SESSION_LIMIT)
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_object(conn, str(d["order_id"]), d["order_ts"], d)
